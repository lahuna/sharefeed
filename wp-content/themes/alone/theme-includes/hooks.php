...
if(!function_exists('_alone_customizer_live_preview')) :
	/**
	 * _alone_customizer_live_preview
	 * Fix cache file stylesheet mode Customizer Live Preview
 	 */
	function _alone_customizer_live_preview()
	{
		...
		wp_enqueue_style(
			...
			array('bootstrap'),
			$alone_version . '.' . rand(1, rand(99, 999999999))
		);
	}
endif;
add_action( 'customize_preview_init', '_alone_customizer_live_preview' );
	...
	function _alone_filter_fw_ext_backups_demos($demos)
	{
		$demos_array = array(
			'alone-charity' => array(
				...
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone/alone-charity/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-charity/',
			),
			'alone-charitable' => array(
				'title' => esc_html__('Alone Charitable', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone/alone-charitable/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-charitable/',
			),
			'alone-childrents' => array(
				'title' => esc_html__('Alone Childrents', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone/alone-childrents/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-childrents/',
			),
			'alone-event-party' => array(
				'title' => esc_html__('Alone Event Party', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone/alone-event-party/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-event-party/',
			),
			'alone-organization' => array(
				'title' => esc_html__('Alone NGO Organization', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone/alone-organization/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-organization/',
			),
			'alone-church-2' => array(
				'title' => esc_html__('Alone Church 2', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone/alone-church-2/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-church-2/',
			),
			'alone-church' => array(
